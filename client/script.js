...
/*
    ...
    callback function to. Inside the callback function, 
    console.log the response's data (in the intermediate instructions we'll 
...
const getRequest = () => {
  axios
    .get(`${getURL}/query-test/?name=Dallin&age=25&sport=football`)
    .then((res) => {
      console.log(res.data);
    })
    .catch((error) => {
...
/*
    ...
    Next, create an object called body inside the function. It should have one key-value pair. The key should be newFood (make sure to match the case and spelling exactly) 
